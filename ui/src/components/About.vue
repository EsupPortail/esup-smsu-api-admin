...
<ul>
	<li>Abdouroihamane Anli</li>
	<li>Benoît Roques</li>
</ul>
	
Direction et coordination du projet actuel :
<ul>
	<li>Pascal Rigaux</li>
</ul>
...
<ul>
	<li><a href="http://www.esup-portail.org/display/PROJSMSU/ESUP-SMS-U" target="_blank">http://www.esup-portail.org/display/PROJSMSU/ESUP-SMS-U</a></li>
	<li><a href="http://github.com/EsupPortail/esup-smsu-api-admin" target="_blank">http://github.com/EsupPortail/esup-smsu</a></li>
</ul>
